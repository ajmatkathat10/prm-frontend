...
const ENDPOINT_SUCCESS_MESSAGES: Record<string, string> = {
  ...
  deactivateEmployee: 'Employee profile deactivated successfully',
  addEmployeeSkill: 'Skill added to employee profile',
  updateEmployeeSkill: 'Skill proficiency updated successfully',
  removeEmployeeSkill: 'Skill removed from employee profile',
